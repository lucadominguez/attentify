...
export interface AppStore {
  ...
  /** Domains the false-negative review already asked about, with the last-asked epoch.
   *  Stops the "was this a distraction?" prompt from re-nagging: a rejected domain is
   *  parked far in the future, a merely-asked one for a cooldown window. */
  reviewedFalseNegatives?: Record<string, number>
